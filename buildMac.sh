...
scp -P 22220 ofdo.spec ofdo.py kirjakohad.py laulud.py piibel.xml pyhad.py slaidigeneraatorid.py uuendaja.py stiilid.odp annetus.png mycomputer@localhost:~/Desktop/KRAAM
